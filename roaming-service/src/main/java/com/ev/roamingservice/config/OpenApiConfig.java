...
/**
 * OpenAPI Configuration for Roaming Service
 */
@Configuration
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI roamingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Roaming Service API")
                        .description("Roaming Service for EV SaaS Platform - Handles OCPI protocol implementation for roaming between CPOs and MSPs")
                        .version("1.0.0")
                        .contact(new Contact()
