...
/**
 * OpenAPI Configuration for Smart Charging Service
 */
@Configuration
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI smartChargingOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Smart Charging API")
                        .description("Smart Charging Service for EV SaaS Platform - Handles load balancing, energy optimization, and smart charging algorithms")
                        .version("1.0.0")
                        .contact(new Contact()
